...
async def extract_standings_data(page: Page, context: str = "fs_standings_tab") -> Dict[str, Any]:
    ...
    selectors = {
        ...
        "standings_col_rank": SelectorManager.get_selector(context, "standings_col_rank") or ".table__cell--rank",
        "standings_col_team_name": SelectorManager.get_selector(context, "standings_col_team_name") or ".table__cell--participant",
        "standings_col_team_link": SelectorManager.get_selector(context, "standings_col_team_link") or ".table__cell--participant a",
        "standings_col_matches_played": SelectorManager.get_selector(context, "standings_col_matches_played") or ".table__cell--value:nth-child(3)",
        "standings_col_wins": SelectorManager.get_selector(context, "standings_col_wins") or ".table__cell--value:nth-child(4)",
        "standings_col_draws": SelectorManager.get_selector(context, "standings_col_draws") or ".table__cell--value:nth-child(5)",
        "standings_col_losses": SelectorManager.get_selector(context, "standings_col_losses") or ".table__cell--value:nth-child(6)",
        "standings_col_goals": SelectorManager.get_selector(context, "standings_col_goals") or ".table__cell--score",
        "standings_col_points": SelectorManager.get_selector(context, "standings_col_points") or ".table__cell--points",
        "standings_col_form": SelectorManager.get_selector(context, "standings_col_form") or ".table__cell--form",
